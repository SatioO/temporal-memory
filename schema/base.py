"""
Zero-dependency base for domain and payload models.

Provides:
  - Model.from_dict()  — recursive deserialization from plain dicts
  - Model.to_dict()    — recursive serialization to JSON-safe primitives
  - Model.to_json()    — JSON string shorthand
"""
import dataclasses
import json
...
class Model:
    """
    Mixin for @dataclass types — adds from_dict / to_dict / to_json.

    Inherit *before* using @dataclass:
